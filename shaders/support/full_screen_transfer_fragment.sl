...
{
    brx_float ambient_occlusion = brx_load_2d(g_in_texture[0], brx_int3(brx_frag_coord.xy, 0)).x;
    out_image = brx_float4(ambient_occlusion, ambient_occlusion, ambient_occlusion, 1.0);
}